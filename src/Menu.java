...
public class Menu {
    ...
    String[][][] menu = {
            {
                    {"마라탕","맛있습니다."},{"0단계","안맵습니다."},{"8000", "원"}
            },
            {
                    {"마라탕","맛있습니다."},{"1단계","신라면정도."},{"8000", "원"}
            },
            {
                    {"마라탕","맛있습니다."},{"2단계","얼얼합니다."},{"8000", "원"}
            },
            {
                    {"꿔바로우","바삭합니다."},{"사천","매콤합니다"},{"15000", "원"}
            },
            {
                    {"꿔바로우","바삭합니다."},{"찹쌀","쫀득합니다"},{"15000", "원"}
            },
            {
                    {"꿔바로우","바삭합니다."},{"미니","저렴합니다"},{"7000", "원"}
            },
            {
